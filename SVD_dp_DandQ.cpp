...
magma_int_t m=800 , n =2*800 , n2=m*n, min_mn = min(m,n);
...
double aux_work[1];
magma_dgesdd(MagmaSomeVec,m,n,r,m,s1,u,m,vt,n,aux_work,-1,iwork,&info);
lwork= (magma_int_t)aux_work[0];
magma_dmalloc_pinned(&h_work , lwork);
magma_dgesdd(MagmaSomeVec,m,n,r,m,s1,u,m,vt,n,h_work,lwork,iwork,&info);

gpu_time = magma_wtime () - gpu_time ;
printf (" dgesdd gpu time : %7.5f\n", gpu_time ); // Magma time


cpu_time = magma_wtime ();
lapackf77_dgesdd("S",&m ,&n,a ,&m,s2 ,u ,&m,vt ,&n,h_work ,&lwork, iwork, &info);
cpu_time = magma_wtime () - cpu_time ;
printf (" sgesdd cpu time : %7.5f\n", cpu_time ); // Lapack time
